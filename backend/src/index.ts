...
import createEpisodeRouter from './routes/admin/createEpisode.js';
import deleteEpisodeRouter from './routes/admin/deleteEpisode.js';
...
import backfillDescriptionTrRouter from './routes/admin/backfillDescriptionTr.js';
import backfillEpisodeDescriptionsRouter from './routes/admin/backfillEpisodeDescriptions.js';
import commentModerationRouter from './routes/admin/commentModeration.js';
...
app.use('/api/admin', createEpisodeRouter);
app.use('/api/admin', deleteEpisodeRouter);
app.use('/api/admin', jobsRouter);
app.use('/api/admin', calendarSyncRouter);
app.use('/api/admin', syncAnilistAdultFlagsRouter);
app.use('/api/admin', backfillDescriptionTrRouter);
app.use('/api/admin', backfillEpisodeDescriptionsRouter);
app.use('/api/admin', commentModerationRouter);
app.use('/api/admin', teamApplicationsRouter);
