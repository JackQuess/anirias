    ...
    <div className="min-h-screen bg-background font-inter flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-6 p-6">
         <div className="relative inline-block">
            ...
            <div className="absolute top-0 left-0 w-full h-full text-primary opacity-50 blur-sm animate-pulse" style={{ clipPath: 'inset(40% 0 61% 0)' }}>404</div>
         </div>

         <div className="space-y-2">
            <h2 className="text-2xl md:text-4xl font-black text-white uppercase italic tracking-widest">SİNYAL <span className="text-primary">KAYBI</span></h2>
         ...
         <div className="pt-8">
            <Link to="/" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/50 transition-all">
